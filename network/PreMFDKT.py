...
class PreMFDKT(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim, num_layers, dropout, user_num, max_seq_len,
        ...
        self.MF = MF(user_num=user_num, skill_num=skill_num, embedding_dim=skill_num, hidden_dim=hidden_dim,output_dim=1)
