...
class DKT(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_dim, hidden_dim, max_sequence_len, num_layers, dropout):
        super().__init__()
        ...
        self._decoder = nn.Linear(hidden_dim, embedding_dim)
    ...
    def forward(self, input, query_question, target_id, use_pretrained_embedding=False, traditional=True):
        """
